  ...
  <div class="navbar">
    <div class="left-side">
      <a-space>
        ...
        <a-typography-title :style="{ margin: 0, fontSize: '18px', fontWeight: 700 }" :heading="5">
          Arsenal | 安森纳
        </a-typography-title>
    ...
    <ul class="right-side">
      <li>
        <a-tooltip :content="$t('settings.online')">
          <a-button @click="handleLink" class="nav-btn" type="outline" :shape="'circle'">
            <template #icon>
              <icon-strikethrough />
            </template>
          </a-button>
...
const handleLink = () => {
  const baseUrl = `${import.meta.env.VITE_API_BASE_URL}/doc/index.html`
