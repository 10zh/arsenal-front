export default {
  ...
  'searchTable.operation.create': '新建引擎',
  ...
  'searchTable.columns.updateTime': '最近同步时间',
  'searchTable.columns.port': '引擎RPC端口',
  'searchTable.columns.name': '引擎名称',
  'searchTable.columns.isLocal': '是否为本地引擎',
