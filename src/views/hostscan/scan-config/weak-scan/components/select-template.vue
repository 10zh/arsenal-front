<template>
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="8">
              <a-form-item field="tcpPort" :label="t('scan.template.serviceDiscovery.tcpPort')">
                <a-input v-model="pagination.tcpPort" :placeholder="t('scan.template.serviceDiscovery.input.tcpPort')
                  "></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <a-form-item field="udpPort" :label="t('scan.template.serviceDiscovery.udpPort')">
                <a-input v-model="pagination.udpPort" :placeholder="t('scan.template.serviceDiscovery.input.udpPort')
                  "></a-input>
              </a-form-item>
            </a-col>
          </a-row>
  ...
  <a-table row-key="id" :columns="columns" :data="tableData" :bordered="false" :pagination="false"
    :row-selection="rowSelection" :style="{
      marginBottom: '20px',
      marginLeft: '15px',
