<template>
    <div>
        <a-modal v-model:visible="visible" width="615px" :title="dialogType === 'edit' ? '编辑配置':'新建配置'" title-align="start" @before-ok="handleBeforeOk">
            <a-form ref="formRef" :model="form">
                ...
                <a-form-item
                    ...
                    :rules="[
                    { required: true, message: $t('host.scan.config.target') },
                    ]"
                >
