  ...
  <a-card :style="{ height: (props.tableHeight - 132) + 'px' }">
    <a-tabs type="rounded" @tab-click="changeClick">
      <a-tab-pane key="1">
        ...
        <!-- 主机列表start -->
        <a-table :columns="hostTableColumns" :data="hostData" :bordered="{ cell: true }" :pagination="hostPagination"
      ...
      <a-tab-pane key="2">
        ...
        <!-- 漏洞列表start -->
        <a-table :columns="vulnerabilityTableColumns" :data="vulnerabilityData" column-resize :bordered="{ cell: true }"
          :pagination="vulnerabilityPagination" @page-change="handleHostVulnerabilityTablePageChange">
