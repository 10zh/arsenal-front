                ...
                <a-row :gutter="24">
                    <a-col :span="8">
                        <a-form-item field="status" :label="$t('host.scan.config.configName')">
                            <a-input v-model="pagination.configName"
                                :placeholder="t('host.scan.config.configName.input')"></a-input>
                        </a-form-item>
                    </a-col>
                    <a-col :span="8">
                        <a-form-item field="status" :label="$t('host.scan.config.engineName')">
                            <a-input v-model="pagination.engineName"
                                :placeholder="t('host.scan.config.engineName.input')"></a-input>
                        </a-form-item>
                    </a-col>
                    <a-col :span="8">
                ...
                <a-row :gutter="24">
                    <a-col :span="8">
                        <a-form-item field="status" :label="$t('host.scan.config.target')">
                            <a-input v-model="pagination.target"
                                :placeholder="t('host.scan.config.target.input')"></a-input>
                        </a-form-item>
                    </a-col>
                    <a-col :span="8">
    ...
    <a-table row-key="id" :columns="columns" :bordered="false" :data="tableData" :pagination="false"
        ...
        <template #scanPress="{ record }">
            <div class="progress-wrap">
                <a-progress status="success" style="margin-right: 2px" :show-text="false" :percent="record.lastScanStatic.scanStatus === 6
                    ? 100
                    : record.progressNums
                    " />
        ...
        <template #operations="{ record }">
            ...
            <a-popconfirm :content="t('host.scan.config.operator.delete.ack') +
                record.configName +
                '?'
