export default {
  ...
  'host.scan.config.configName': '配置名称',
  'host.scan.config.configName.input': '请输入扫描配置名称',
  'host.scan.config.engineName': '引擎名称',
  'host.scan.config.engineName.input': '请输入扫描引擎名称',
  'host.scan.config.liveHostNumber': '	主机存活数量',
  'host.scan.config.scanEndTime': '	结束时间',
  'host.scan.config.scanStartTime': '开始时间',
  'host.scan.config.template': '	扫描模板',
  'host.scan.config.templateName': '	模板名称',
  ...
  'host.scan.config.excludeTarget': '排除目标',
  ...
  'host.scan.config.createTime': '创建时间',
