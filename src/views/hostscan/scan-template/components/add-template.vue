                ...
                <a-form-item field="isLocal" :label="t('form.enableArp')">
                  <a-select
                    ...
                    :rules="[
                      {
                        required: true,
                        message: $t('scanengine.add.addressPlaceholder'),
                      },
                    ]"
                  />
                </a-form-item>
            ...
            <a-row style="margin-bottom: 5px" :gutter="24">
              <a-col :span="8">
                <a-form-item
                  ...
                  :label="t('form.assetConcurrency')"
                  :rules="[
                    { required: true, message: $t('scanTemplate.form.errMsg') },
                  ]"
                >
                  <a-input-number
              ...
              <a-col :span="8">
                <a-form-item
                  ...
                  :label="t('form.singleAssetThread')"
                  :rules="[
                    { required: true, message: $t('scanTemplate.form.errMsg') },
                  ]"
                >
