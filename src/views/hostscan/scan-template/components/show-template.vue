      ...
      >
        <div class="content-container">
          ...
          <div class="right-container">
            ...
            >
              <a-input
                ...
                :placeholder="t('form.templateName.placeHolder')"
              />
            </a-form-item>
          ...
          <div class="center-container">
            ...
            <!-- 性能参数表单start -->
            <a-form-item
              field="performance.assetConcurrency"
              :label="t('form.assetConcurrency.label')"
              :rules="[
                {
                  required: true,
            ...
            >
              <a-input-number
                v-model="formModel.performance.assetConcurrency"
              />
            </a-form-item>
            <a-form-item
              field="performance.singleAssetThread"
              :label="t('form.singleAssetThread.label')"
              :rules="[
                {
                  required: true,
            ...
            >
              <a-input-number
                v-model="formModel.performance.singleAssetThread"
              />
            </a-form-item>
            <a-form-item
              field="performance.portScanSpeed"
              :label="t('form.portScanSpeed.label')"
              :rules="[
          ...
          <div class="right-container">
            ...
            <!-- 服务发现表单start -->
            <a-form-item
              field="serviceDiscovery.survivalMode"
              :label="t('form.survivalMode.label')"
            >
              <a-select
                v-model="formModel.serviceDiscovery.tcpDetectType"
                :placeholder="t('form.survivalMode.placeHolder')"
                :options="survivalOptions"
              />
            </a-form-item>
            <a-form-item
              field="serviceDiscovery.tcpPort"
              :label="t('form.tcpPort.label')"
            >
              <a-input
                v-model="formModel.serviceDiscovery.tcpPort"
                :placeholder="$t('form.tcpPort.placeHolder')"
              />
            </a-form-item>
            <a-form-item
              field="serviceDiscovery.udpPort"
              :label="t('form.udpPort.label')"
            >
              <a-input
                v-model="formModel.serviceDiscovery.udpPort"
