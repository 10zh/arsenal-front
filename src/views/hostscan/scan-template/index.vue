<template>
  <div class="container">
    <Breadcrumb :items="['menu.hostscan', 'menu.list.scantemplate']" />
    <a-card class="general-card" :title="$t('menu.list.scantemplate')" :style="'height:'+cardHeight+'px'">
      <a-row>
        <a-col :flex="1">
          <a-form
            :model="formModel"
