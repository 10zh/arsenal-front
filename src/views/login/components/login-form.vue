<template>
  <div class="login-form-wrapper">
    ...
    <a-form ref="loginForm" :model="userInfo" class="login-form" layout="vertical" @submit="handleSubmit">
      ...
      <a-form-item field="captcha" :rules="[{ required: true, message: $t('login.form.captcha.errMsg') }]"
        :validate-trigger="['change', 'blur']" hide-label>
        <a-input v-model="userInfo.captcha" :placeholder="$t('login.form.captcha.placeholder')">
        </a-input>
